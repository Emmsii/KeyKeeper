...
namespace KeyKeeper.World
{
    public class GameWorld
    {
        ...
        public int CurrentDepth => _currentLevel.Depth;

        public GameWorld(GameLevel startingLevel)
        {
            if(startingLevel == null)
            {
                throw new ArgumentNullException("Cannot create game world with anull starting level.", nameof(startingLevel));
            }
