...
namespace KeyKeeper.Input
{
    public static class Controls
    {
        ...
        public static readonly Control EAST = new Control().Bind(Keys.Left).Bind(Keys.NumPad4).Bind(Keys.H);
        public static readonly Control WEST = new Control().Bind(Keys.Right).Bind(Keys.NumPad5).Bind(Keys.L);
        public static readonly Control NORTH_EAST = new Control().Bind(Keys.NumPad9).Bind(Keys.U);
        public static readonly Control NORTH_WEST = new Control().Bind(Keys.NumPad3).Bind(Keys.N);
        public static readonly Control SOUTH_EAST = new Control().Bind(Keys.NumPad1).Bind(Keys.B);
        public static readonly Control SOUTH_WEST = new Control().Bind(Keys.NumPad7).Bind(Keys.Y);
